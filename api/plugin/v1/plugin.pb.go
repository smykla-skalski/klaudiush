...
const file_plugin_v1_plugin_proto_rawDesc = "" +
	...
	"\bValidate\x12\x1a.plugin.v1.ValidateRequest\x1a\x1b.plugin.v1.ValidateResponseB\x99\x01\n" +
	"\rcom.plugin.v1B\vPluginProtoP\x01Z6github.com/smykla-skalski/klaudiush/plugin/v1;pluginv1\xa2\x02\x03PXX\xaa\x02\tPlugin.V1\xca\x02\tPlugin\\V1\xe2\x02\x15Plugin\\V1\\GPBMetadata\xea\x02\n" +
