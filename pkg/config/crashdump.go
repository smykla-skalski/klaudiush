...
type CrashDumpConfig struct {
	...
	DumpDir *string `json:"dump_dir,omitempty" koanf:"dump_dir" toml:"dump_dir"`

	// MaxDumps is the maximum number of crash dumps to keep.
	// Default: 10
	MaxDumps *int `json:"max_dumps,omitempty" koanf:"max_dumps" toml:"max_dumps"`
	...
	// Default: true
	IncludeConfig *bool `json:"include_config,omitempty" koanf:"include_config" toml:"include_config"`

	// IncludeContext controls whether hook context is included in dumps.
	// Default: true
	IncludeContext *bool `json:"include_context,omitempty" koanf:"include_context" toml:"include_context"`
}
