...
type GitConfig struct {
	...
	Commit *CommitValidatorConfig `json:"commit,omitempty" koanf:"commit" toml:"commit,omitempty"`

	// Push validator configuration
	Push *PushValidatorConfig `json:"push,omitempty" koanf:"push" toml:"push,omitempty"`

	// Fetch validator configuration
	Fetch *FetchValidatorConfig `json:"fetch,omitempty" koanf:"fetch" toml:"fetch,omitempty"`

	// Add validator configuration
	Add *AddValidatorConfig `json:"add,omitempty" koanf:"add" toml:"add,omitempty"`

	// PR validator configuration
	PR *PRValidatorConfig `json:"pr,omitempty" koanf:"pr" toml:"pr,omitempty"`

	// Merge validator configuration
	Merge *MergeValidatorConfig `json:"merge,omitempty" koanf:"merge" toml:"merge,omitempty"`

	// Branch validator configuration
	Branch *BranchValidatorConfig `json:"branch,omitempty" koanf:"branch" toml:"branch,omitempty"`

	// NoVerify validator configuration
	NoVerify *NoVerifyValidatorConfig `json:"no_verify,omitempty" koanf:"no_verify" toml:"no_verify,omitempty"`
}
...
type CommitValidatorConfig struct {
	...
	// Default: ["-s", "-S"]
	RequiredFlags []string `json:"required_flags,omitempty" koanf:"required_flags" toml:"required_flags,omitempty"`

	// CheckStagingArea enables checking that files are staged before commit.
	// Default: true
	CheckStagingArea *bool `json:"check_staging_area,omitempty" koanf:"check_staging_area" toml:"check_staging_area,omitempty"`

	// Message contains commit message validation settings.
	Message *CommitMessageConfig `json:"message,omitempty" koanf:"message" toml:"message,omitempty"`
}
...
type CommitMessageConfig struct {
	...
	// Default: 50
	TitleMaxLength *int `json:"title_max_length,omitempty" koanf:"title_max_length" toml:"title_max_length,omitempty"`
	...
	// Default: true
	AllowUnlimitedRevertTitle *bool `json:"allow_unlimited_revert_title,omitempty" koanf:"allow_unlimited_revert_title" toml:"allow_unlimited_revert_title,omitempty"`

	// BodyMaxLineLength is the maximum allowed length for body lines.
	// Default: 72
	BodyMaxLineLength *int `json:"body_max_line_length,omitempty" koanf:"body_max_line_length" toml:"body_max_line_length,omitempty"`

	// BodyLineTolerance allows body lines to exceed max length by this amount.
	// Default: 5 (total: 77 characters)
	BodyLineTolerance *int `json:"body_line_tolerance,omitempty" koanf:"body_line_tolerance" toml:"body_line_tolerance,omitempty"`

	// ConventionalCommits enforces conventional commit format (type(scope): description).
	// Default: true
	ConventionalCommits *bool `json:"conventional_commits,omitempty" koanf:"conventional_commits" toml:"conventional_commits,omitempty"`

	// ValidTypes is the list of valid commit types.
	// Default: ["build", "chore", "ci", "docs", "feat", "fix", "perf", "refactor", "revert", "style", "test"]
	ValidTypes []string `json:"valid_types,omitempty" koanf:"valid_types" toml:"valid_types,omitempty"`

	// RequireScope enforces that conventional commits must have a scope.
	// Default: true
	RequireScope *bool `json:"require_scope,omitempty" koanf:"require_scope" toml:"require_scope,omitempty"`

	// BlockInfraScopeMisuse blocks feat/fix with infrastructure scopes (ci, test, docs, build).
	// Default: true
	BlockInfraScopeMisuse *bool `json:"block_infra_scope_misuse,omitempty" koanf:"block_infra_scope_misuse" toml:"block_infra_scope_misuse,omitempty"`
	...
	CommitStyle string `json:"commit_style,omitempty" jsonschema:"enum=conventional,enum=scope-only,enum=none,enum=custom,enum=auto" koanf:"commit_style" toml:"commit_style,omitempty"`
	...
	TitlePattern string `json:"title_pattern,omitempty" koanf:"title_pattern" toml:"title_pattern,omitempty"`
	...
	ExpectedSignoff string `json:"expected_signoff,omitempty" koanf:"expected_signoff" toml:"expected_signoff,omitempty"`
}
...
type PushValidatorConfig struct {
	...
	// Default: []
	BlockedRemotes []string `json:"blocked_remotes,omitempty" koanf:"blocked_remotes" toml:"blocked_remotes,omitempty"`
...
type AddValidatorConfig struct {
	...
	// Default: ["tmp/*"]
	BlockedPatterns []string `json:"blocked_patterns,omitempty" koanf:"blocked_patterns" toml:"blocked_patterns,omitempty"`
}
...
type PRValidatorConfig struct {
	...
	// Default: true
	TitleConventionalCommits *bool `json:"title_conventional_commits,omitempty" koanf:"title_conventional_commits" toml:"title_conventional_commits,omitempty"`
	...
	RequireChangelog *bool `json:"require_changelog,omitempty" koanf:"require_changelog" toml:"require_changelog,omitempty"`

	// CheckCILabels enables checking for ci/ labels and providing suggestions.
	// Default: true
	CheckCILabels *bool `json:"check_ci_labels,omitempty" koanf:"check_ci_labels" toml:"check_ci_labels,omitempty"`
	...
	TitleStyle string `json:"title_style,omitempty" jsonschema:"enum=conventional,enum=scope-only,enum=none,enum=custom,enum=auto" koanf:"title_style" toml:"title_style,omitempty"`
...
type MergeValidatorConfig struct {
	...
	Message *MergeMessageConfig `json:"message,omitempty" koanf:"message" toml:"message,omitempty"`

	// ValidateAutomerge validates PR before enabling auto-merge.
	// Default: true
	ValidateAutomerge *bool `json:"validate_automerge,omitempty" koanf:"validate_automerge" toml:"validate_automerge,omitempty"`
	...
	// Default: true
	RequireSignoff *bool `json:"require_signoff,omitempty" koanf:"require_signoff" toml:"require_signoff,omitempty"`
...
type BranchValidatorConfig struct {
	...
	// Default: ["main", "master"]
	ProtectedBranches []string `json:"protected_branches,omitempty" koanf:"protected_branches" toml:"protected_branches,omitempty"`
	...
	// Default: true
	RequireType *bool `json:"require_type,omitempty" koanf:"require_type" toml:"require_type,omitempty"`

	// AllowUppercase allows uppercase letters in branch names.
	// Default: false
	AllowUppercase *bool `json:"allow_uppercase,omitempty" koanf:"allow_uppercase" toml:"allow_uppercase,omitempty"`
}
