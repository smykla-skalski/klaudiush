...
type FileConfig struct {
	...
	Markdown *MarkdownValidatorConfig `json:"markdown,omitempty" koanf:"markdown" toml:"markdown,omitempty"`

	// ShellScript validator configuration
	ShellScript *ShellScriptValidatorConfig `json:"shellscript,omitempty" koanf:"shellscript" toml:"shellscript,omitempty"`

	// Terraform validator configuration
	Terraform *TerraformValidatorConfig `json:"terraform,omitempty" koanf:"terraform" toml:"terraform,omitempty"`

	// Workflow validator configuration (GitHub Actions)
	Workflow *WorkflowValidatorConfig `json:"workflow,omitempty" koanf:"workflow" toml:"workflow,omitempty"`

	// Gofumpt validator configuration (Go formatting)
	Gofumpt *GofumptValidatorConfig `json:"gofumpt,omitempty" koanf:"gofumpt" toml:"gofumpt,omitempty"`

	// Python validator configuration
	Python *PythonValidatorConfig `json:"python,omitempty" koanf:"python" toml:"python,omitempty"`

	// JavaScript validator configuration
	JavaScript *JavaScriptValidatorConfig `json:"javascript,omitempty" koanf:"javascript" toml:"javascript,omitempty"`

	// Rust validator configuration
	Rust *RustValidatorConfig `json:"rust,omitempty" koanf:"rust" toml:"rust,omitempty"`
...
type MarkdownValidatorConfig struct {
	...
	// Default: 2
	ContextLines *int `json:"context_lines,omitempty" koanf:"context_lines" toml:"context_lines,omitempty"`

	// HeadingSpacing enforces blank lines around headings (custom rule).
	// Default: true
	HeadingSpacing *bool `json:"heading_spacing,omitempty" koanf:"heading_spacing" toml:"heading_spacing,omitempty"`

	// CodeBlockFormatting enforces proper code block formatting (custom rule).
	// Default: true
	CodeBlockFormatting *bool `json:"code_block_formatting,omitempty" koanf:"code_block_formatting" toml:"code_block_formatting,omitempty"`

	// ListFormatting enforces proper list item formatting and spacing (custom rule).
	// Default: true
	ListFormatting *bool `json:"list_formatting,omitempty" koanf:"list_formatting" toml:"list_formatting,omitempty"`

	// UseMarkdownlint enables markdownlint-cli integration if available.
	// Default: true
	UseMarkdownlint *bool `json:"use_markdownlint,omitempty" koanf:"use_markdownlint" toml:"use_markdownlint,omitempty"`
	...
	// Default: true
	SkipPlanDocuments *bool `json:"skip_plan_documents,omitempty" koanf:"skip_plan_documents" toml:"skip_plan_documents,omitempty"`
	...
	// Default: true
	SkipClaudeCodeFiles *bool `json:"skip_claude_code_files,omitempty" koanf:"skip_claude_code_files" toml:"skip_claude_code_files,omitempty"`

	// MarkdownlintPath is the path to the markdownlint binary.
	// Default: "" (use PATH)
	MarkdownlintPath string `json:"markdownlint_path,omitempty" koanf:"markdownlint_path" toml:"markdownlint_path,omitempty"`
	...
	MarkdownlintRules map[string]bool `json:"markdownlint_rules,omitempty" koanf:"markdownlint_rules" toml:"markdownlint_rules,omitempty"`
	...
	MarkdownlintConfig string `json:"markdownlint_config,omitempty" koanf:"markdownlint_config" toml:"markdownlint_config,omitempty"`
	...
	// Default: true
	TableFormatting *bool `json:"table_formatting,omitempty" koanf:"table_formatting" toml:"table_formatting,omitempty"`
	...
	TableFormattingMode string `json:"table_formatting_mode,omitempty" jsonschema:"enum=display_width,enum=byte_width" koanf:"table_formatting_mode" toml:"table_formatting_mode,omitempty"`
	...
	// Default: "warning"
	TableFormattingSeverity string `json:"table_formatting_severity,omitempty" jsonschema:"enum=warning,enum=error" koanf:"table_formatting_severity" toml:"table_formatting_severity,omitempty"`
}
...
type ShellScriptValidatorConfig struct {
	...
	// Default: true
	UseShellcheck *bool `json:"use_shellcheck,omitempty" koanf:"use_shellcheck" toml:"use_shellcheck,omitempty"`

	// ShellcheckSeverity is the minimum severity level for shellcheck findings.
	// Options: "error", "warning", "info", "style"
	// Default: "warning"
	ShellcheckSeverity string `json:"shellcheck_severity,omitempty" jsonschema:"enum=error,enum=warning,enum=info,enum=style" koanf:"shellcheck_severity" toml:"shellcheck_severity,omitempty"`

	// ExcludeRules is a list of shellcheck rules to exclude (e.g., ["SC2086", "SC2154"]).
	// Default: []
	ExcludeRules []string `json:"exclude_rules,omitempty" koanf:"exclude_rules" toml:"exclude_rules,omitempty"`

	// ShellcheckPath is the path to the shellcheck binary.
	// Default: "" (use PATH)
	ShellcheckPath string `json:"shellcheck_path,omitempty" koanf:"shellcheck_path" toml:"shellcheck_path,omitempty"`
}
...
type TerraformValidatorConfig struct {
	...
	// Default: "auto"
	ToolPreference string `json:"tool_preference,omitempty" jsonschema:"enum=tofu,enum=terraform,enum=auto" koanf:"tool_preference" toml:"tool_preference,omitempty"`

	// CheckFormat enables terraform/tofu format checking.
	// Default: true
	CheckFormat *bool `json:"check_format,omitempty" koanf:"check_format" toml:"check_format,omitempty"`

	// UseTflint enables tflint integration if available.
	// Default: true
	UseTflint *bool `json:"use_tflint,omitempty" koanf:"use_tflint" toml:"use_tflint,omitempty"`

	// TerraformPath is the path to the terraform binary.
	// Default: "" (use PATH)
	TerraformPath string `json:"terraform_path,omitempty" koanf:"terraform_path" toml:"terraform_path,omitempty"`

	// TofuPath is the path to the tofu binary.
	// Default: "" (use PATH)
	TofuPath string `json:"tofu_path,omitempty" koanf:"tofu_path" toml:"tofu_path,omitempty"`

	// TflintPath is the path to the tflint binary.
	// Default: "" (use PATH)
	TflintPath string `json:"tflint_path,omitempty" koanf:"tflint_path" toml:"tflint_path,omitempty"`
}
...
type WorkflowValidatorConfig struct {
	...
	// Default: "5s"
	GHAPITimeout Duration `json:"gh_api_timeout,omitempty" koanf:"gh_api_timeout" toml:"gh_api_timeout,omitempty"`

	// EnforceDigestPinning requires actions to be pinned by digest.
	// Default: true
	EnforceDigestPinning *bool `json:"enforce_digest_pinning,omitempty" koanf:"enforce_digest_pinning" toml:"enforce_digest_pinning,omitempty"`

	// RequireVersionComment requires a version comment when using digest pinning.
	// Format: uses: actions/checkout@sha256... # v4.1.7
	// Default: true
	RequireVersionComment *bool `json:"require_version_comment,omitempty" koanf:"require_version_comment" toml:"require_version_comment,omitempty"`

	// CheckLatestVersion checks if the version comment matches the latest release.
	// Default: true
	CheckLatestVersion *bool `json:"check_latest_version,omitempty" koanf:"check_latest_version" toml:"check_latest_version,omitempty"`

	// UseActionlint enables actionlint integration if available.
	// Default: true
	UseActionlint *bool `json:"use_actionlint,omitempty" koanf:"use_actionlint" toml:"use_actionlint,omitempty"`

	// ActionlintPath is the path to the actionlint binary.
	// Default: "" (use PATH)
	ActionlintPath string `json:"actionlint_path,omitempty" koanf:"actionlint_path" toml:"actionlint_path,omitempty"`
}
...
type GofumptValidatorConfig struct {
	...
	// Default: false
	ExtraRules *bool `json:"extra_rules,omitempty" koanf:"extra_rules" toml:"extra_rules,omitempty"`

	// Lang specifies the Go language version (e.g., "go1.21").
	// If not specified, auto-detected from go.mod if available.
	// Default: "" (auto-detect)
	Lang string `json:"lang,omitempty" koanf:"lang" toml:"lang,omitempty"`

	// ModPath specifies the module path for gofumpt.
	// If not specified, auto-detected from go.mod if available.
	// Default: "" (auto-detect)
	ModPath string `json:"modpath,omitempty" koanf:"modpath" toml:"modpath,omitempty"`

	// GofumptPath is the path to the gofumpt binary.
	// Default: "" (use PATH)
	GofumptPath string `json:"gofumpt_path,omitempty" koanf:"gofumpt_path" toml:"gofumpt_path,omitempty"`
}
...
type PythonValidatorConfig struct {
	...
	// Default: true
	UseRuff *bool `json:"use_ruff,omitempty" koanf:"use_ruff" toml:"use_ruff,omitempty"`

	// RuffPath is the path to the ruff binary.
	// Default: "" (use PATH)
	RuffPath string `json:"ruff_path,omitempty" koanf:"ruff_path" toml:"ruff_path,omitempty"`
	...
	RuffConfig string `json:"ruff_config,omitempty" koanf:"ruff_config" toml:"ruff_config,omitempty"`
}
...
type JavaScriptValidatorConfig struct {
	...
	// Default: true
	UseOxlint *bool `json:"use_oxlint,omitempty" koanf:"use_oxlint" toml:"use_oxlint,omitempty"`

	// OxlintPath is the path to the oxlint binary.
	// Default: "" (use PATH)
	OxlintPath string `json:"oxlint_path,omitempty" koanf:"oxlint_path" toml:"oxlint_path,omitempty"`
	...
	OxlintConfig string `json:"oxlint_config,omitempty" koanf:"oxlint_config" toml:"oxlint_config,omitempty"`
}
...
type RustValidatorConfig struct {
	...
	// Default: true
	UseRustfmt *bool `json:"use_rustfmt,omitempty" koanf:"use_rustfmt" toml:"use_rustfmt,omitempty"`

	// Edition is the Rust edition (2015, 2018, 2021, 2024).
	// If not specified, auto-detected from Cargo.toml if available.
	// Default: "2021"
	Edition string `json:"edition,omitempty" jsonschema:"enum=2015,enum=2018,enum=2021,enum=2024" koanf:"edition" toml:"edition,omitempty"`

	// RustfmtPath is the path to the rustfmt binary.
	// Default: "" (use PATH)
	RustfmtPath string `json:"rustfmt_path,omitempty" koanf:"rustfmt_path" toml:"rustfmt_path,omitempty"`

	// RustfmtConfig is the path to a rustfmt configuration file (rustfmt.toml).
	// Default: "" (use rustfmt defaults)
	RustfmtConfig string `json:"rustfmt_config,omitempty" koanf:"rustfmt_config" toml:"rustfmt_config,omitempty"`
}
